...
// QWERTY, RUNESCAPE, LEAGUE, and ARROW_KEYS are base layers - must be mutally exclusive.
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | Ctrl |      | Gui  |  Alt | Lower|    Space    | Raise| Alt  | Gui  |      |Switch|
     * `-----------------------------------------------------------------------------------'
     *
    ...
    [_LEAGUE] = LAYOUT_planck_mit(
        ...
        KC_LCTL, KC_NO,   KC_NO,   KC_LALT, KC_GRV,      _______,      MO(_FKEYS), _______, _______,  _______, _______
    ),
    ...
    [_LOWER] = LAYOUT_planck_mit(
        ...
        _______, _______, _______,      _______, _______,           _______,      KC_NO,         _______,       _______,       _______,      KC_NO
    ),
    ...
    [_RAISE] = LAYOUT_planck_mit(
        ...
        _______, KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F6,      KC_F7,      KC_F8,      KC_F9,      KC_F10,     _______,
        _______, _______,    _______,    _______,    KC_NO,             _______,         _______,    _______,    _______,    _______,    KC_NO
    ),
    ...
    [_FKEYS] = LAYOUT_planck_mit(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______,      _______,     KC_TRNS, _______, _______, _______, KC_NO
    ),
    ...
    [_MOVE] = LAYOUT_planck_mit(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,  _______,
        _______, _______, _______, _______, KC_NO,        KC_DEL,      KC_NO,   _______, _______,  _______,  KC_NO
    )
};
